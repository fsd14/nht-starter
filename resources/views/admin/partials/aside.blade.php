			...
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
					...
					<ul class="sub">
						...
						<li class="{{ Request::is("admin/roles*") ? 'active' : '' }}"><a href="horizontal_menu.html">{{ trans('admin/general.modules.role') }}</a></li>
						<li class="{{ Request::is("admin/permissions*") ? 'active' : '' }}"><a href="language_switch.html">{{ trans('admin/general.modules.permission') }}</a></li>
					</ul>
				</li>
			</ul>
		</div>
